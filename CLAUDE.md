...
| `src/utils/*.ts` (28) | Pure domain logic, all business rules → §6 (plus `receiptScan.ts`, the shared Gemini-OCR picker used by `AddExpenseScreen` **and** `QuickAddSheet` — callback-based on purpose, see its header) |
